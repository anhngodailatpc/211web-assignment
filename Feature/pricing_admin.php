...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Nunito:ital,wght@0,200;1,600&family=Thasadith&display=swap"
    rel="stylesheet" />
  <!-- ICON FOOTER -->
    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          ...
          <div class="col-xs-6 col-md-6">
            <a href="#addEmployeeModal" style="margin: 0px 10px" class="btn btn-success col-xs-2 col-md-3"
              data-toggle="modal" style='width:10em;'> <span>Thêm mới</span></a>
            <a href="JavaScript:void(0);" class="btn btn-danger col-xs-2 col-md-3" id="delete_multiple"
              style='width:10em;'><span>Xóa</span></a>
            ...
            <tr id="<?php echo $row["name"] ?>">
              ...
              <td>
                <a href="#editEmployeeModal" class="edit" data-toggle="modal">
                  <i class="update" data-toggle="tooltip" data-id="<?php echo $row["name"]; ?>"
                    data-name="<?php echo $row["name"]; ?>" data-monthlyPrice="<?php echo $row["monthlyPrice"]; ?>"
                    data-onlineStore="<?php echo $row["onlineStore"]; ?>"
                    data-UnlimitedProducts="<?php echo $row["UnlimitedProducts"]; ?>"
                    data-StaffAccounts="<?php echo $row["StaffAccounts"]; ?>"
                    data-Support="<?php echo $row["Support"]; ?>"
                    data-SalesChannels="<?php echo $row["SalesChannels"]; ?>"
                    data-Locations="<?php echo $row["Locations"]; ?>"
                    data-ManualOrderCreation="<?php echo $row["ManualOrderCreation"]; ?>"
                    data-DiscountCodes="<?php echo $row["DiscountCodes"]; ?>"
                    data-FreeSSL="<?php echo $row["FreeSSL"]; ?>"
                    data-AbandonedCartRecovery="<?php echo $row["AbandonedCartRecovery"]; ?>"
                    data-GiftCards="<?php echo $row["GiftCards"]; ?>"
                    data-ProfessionalReports="<?php echo $row["ProfessionalReports"]; ?>"
                    data-AdvancedReportBuilder="<?php echo $row["AdvancedReportBuilder"]; ?>"
                    data-ShippingRates="<?php echo $row["ShippingRates"]; ?>"
                    data-ShippingDiscount="<?php echo $row["ShippingDiscount"]; ?>"
                    data-PrintShipping="<?php echo $row["PrintShipping"]; ?>" data-USPS="<?php echo $row["USPS"]; ?>"
                    data-FraudAnalysis="<?php echo $row["FraudAnalysis"]; ?>"
                    data-OnlineCreditCard="<?php echo $row["OnlineCreditCard"]; ?>"
                    data-InpersonCreditCard="<?php echo $row["InpersonCreditCard"]; ?>"
                    data-Additional="<?php echo $row["Additional"]; ?>" data-POSLite="<?php echo $row["POSLite"]; ?>"
                    data-POSPro="<?php echo $row["POSPro"]; ?>"
                    data-SellCurrencies="<?php echo $row["SellCurrencies"]; ?>"
                    data-Exchange="<?php echo $row["Exchange"]; ?>"
                    data-SellLanguage="<?php echo $row["SellLanguage"]; ?>"
                    data-Domains="<?php echo $row["Domains"]; ?>" title="Chỉnh sửa">Sửa</i>
          ...
          <form id="user_form">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="ManualOrderCreation" id="ManualOrderCreation" name="ManualOrderCreation"
                  class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="AbandonedCartRecovery" id="AbandonedCartRecovery" name="AbandonedCartRecovery"
                  class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="ProfessionalReports" id="ProfessionalReports" name="ProfessionalReports"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>AdvancedReportBuilder</label>
                <input type="AdvancedReportBuilder" id="AdvancedReportBuilder" name="AdvancedReportBuilder"
                  class="form-control">
              </div>
              <div class="form-group">
        ...
        <div class="modal-content">
          <form id="update_form">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>ManualOrderCreation</label>
                <input type="ManualOrderCreation" id="ManualOrderCreation_u" name="ManualOrderCreation"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>DiscountCodes</label>
              ...
              <div class="form-group">
                <label>AbandonedCartRecovery</label>
                <input type="AbandonedCartRecovery" id="AbandonedCartRecovery_u" name="AbandonedCartRecovery"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>GiftCards</label>
              ...
              <div class="form-group">
                <label>ProfessionalReports</label>
                <input type="ProfessionalReports" id="ProfessionalReports_u" name="ProfessionalReports"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>AdvancedReportBuilder</label>
                <input type="AdvancedReportBuilder" id="AdvancedReportBuilder_u" name="AdvancedReportBuilder"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>ShippingRates</label>
              ...
              <div class="form-group">
                <label>InpersonCreditCard</label>
                <input type="InpersonCreditCard" id="InpersonCreditCard_u" name="InpersonCreditCard"
                  class="form-control">
              </div>
              <div class="form-group">
                <label>Additional</label>
