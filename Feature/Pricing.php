  ...
  <div id="body-content">
    ...
    <table class="table" id="my-table-basic">
      ...
      <tbody>
        ...
        <tr>
          <td>Shopify POS Pro<br />Các công cụ quản lý cửa hàng và các tính năng đa kênh cần thiết cho các doanh nghiệp.
          </td>
          <td><span class="my-ok-icon">&#10003;</span></td>
        </tr>
        <tr class="my-second-title">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          Thêm sản phẩm vào bất kỳ trang web hoặc blog nào và chấp nhận thanh toán bằng thẻ tín dụng chỉ với $ 9 USD mỗi
          tháng.<br />
        </div>
      </div>

      <p style="margin-top: 3em">Shopify thu thuế bán hàng tại các tiểu bang nơi luật pháp yêu cầu. Giá đã nêu không bao
        gồm các loại thuế này</p>
    </div>
    <!--Body Part 3-->
