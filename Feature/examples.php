    ...
    <div id="section1">
      <div class="row">
        <div class="col-sm">
          ...
          <div class="row content">Từ cửa hàng giày tới cửa hàng thức ăn, hãy cùng xem qua các sản phẩm chúng tôi đã
            thiết kế và chọn ý tưởng cho cửa hàng của bạn</div>
        </div>
        <div class="col-sm">
