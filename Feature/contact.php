...
<body>
  <div id="whole-page">
    ...
    <div class="container-fluid" style="padding-top: 8em">
      ...
      <div class="col-sm-12" id="part2" style="text-align: center;">
        <img style="width: 400px; margin-bottom: 10px" src="img/contact.jfif" id="my-contact-photo" class="img-fluid"
          alt="Ảnh nhân viên hỗ trợ" />
        <h1 style="font-size: 1.5em">Tham gia cùng với đội ngũ phát triển của chúng tôi</h1>
        <div id="my-pagrap">Bạn sẽ luôn tìm được những nhưng đội ngũ đầy nhiệt huyết, đáng tin cậy và cố gắng để chúng
          ta có được cơ sở kinh doanh tốt nhất</div>
      </div>
    </div>
  </div>
  <!-- Ending Intro Part -->
