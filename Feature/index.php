  ...
  <div id="container">
      ...
      <nav class="header-navbar navbar navbar-expand-md navbar-light">
        ...
        <div class="collapse navbar-collapse" id="header-menu">
          <ul class="navbar-nav">
            ...
            <!-- HANDLE PRICIE -->
            <li class="nav-item"><a class='nav-link' href='./pricing.php'>Bảng giá</a>
            </li>
            <!-- END HANDLE PRICE -->
            <!-- <li class="nav-item">
    ...
    <div id="section2">
      <div id="header_section2">
        ...
        <p>Tạo một trang web thương mại điện tử sẽ giúp bạn tìm kiếm khách hàng, tăng doanh thu và theo dõi hoạt động
          kinh doanh của bạn mỗi ngày</p>
      ...
      <div id="items2_section2">
        <div class="row">
          ...
          <div class="col-sm">
            ...
            <p>Chuyển đổi cửa hàng truyền thống thành cửa hàng trực tuyến và tiếp tục phục vụ khách hàng một cách tốt
              nhất</p>
          </div>
          <div class="col-sm">
    ...
    <div id="section3">
      ...
      <div class="row" id="detail-header-section3">
        <p>Một nền tảng với toàn bộ tính năng hỗ trợ kinh doanh để giúp bạn bắt đầu, điều hành và phát triển công việc
          của bạn</p>
      </div>
      <div class="row" id="row1">
        ...
        <div class="col-sm">
          ...
          <p class="content">Dùng một nền tảng có thể bán sản phẩm ở mọi nơi, cho bất cứ ai thông qua trang web của bạn,
            mạng xã hội và sàn thương mại điện tử</p>
      ...
      <div class="row" id="row2">
        <div class="col-sm">
          ...
          <p class="content">Loại bỏ những phỏng đoán với những công cụ giúp bạn tạo, vận hành và thống kê chiến dịch
            tiếp thị</p>
        </div>
        <div class="col">
      ...
      <div class="row" id="row3">
        ...
        <div class="col-sm">
          ...
          <div class="content">Nắm được các thông tin bạn cần để phát triển - sử dụng một trang duy nhất để quản lý đơn
            hàng, giao nhận và thanh toán ở mọi nơi bạn đến</div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm">
          ...
          <div class="content">
            Hơn <strong>1,000,000 doang nghiệp</strong> trên <strong>175 quốc gia</strong> khắp thế giới đã tạo ra hơn
            <strong>$ 200 triệu Dollar</strong> lợi nhuận khi dùng Shopify
          </div>
          <div class="link">
    ...
    <div id="section5">
      ...
      <div class="row">
        <p class="content">Khám phá và trải nghiệm các dịch vụ của Shopify để giúp bạn xây dựng, vận hành và phát triển
          công việc của bạn</p>
      </div>
      <div class="row">
        <?php
