        ...
        <div class="grid about-us__grid">
          <div class="grid__item grid__item--half about-us__content">
            <div class="section-heading no-gutter">
              ...
              <h1 class="h-1 to-left to-center font-weight-x8">Shopify quyền hạn hơn 1.000.000 doanh nghiệp trên toàn
                thế giới</h1>
              <p class="h-2 h-3 section-heading__subtitle to-left to-center">Nền tảng thương mại tất cả trong một để bắt
                đầu, điều hành và phát triển doanh nghiệp.</p>
            </div>
          </div>
          ...
          <div class="grid__item grid__item--half section-2--content">
            <div class="section-heading section-2--content no-gutter">
              ...
              <p class="text-major to-left to-center no-gutter" style="color: #6b7177">
                Hơn một thập kỷ trước, chúng tôi bắt đầu mở cửa hàng bán ván trượt tuyết trực tuyến. Không có giải pháp
                thương mại điện tử nào vào thời điểm đó cung cấp cho chúng
                tôi phương thức quản lý dẫn đến thành công — vì vậy chúng tôi đã xây dựng giải pháp của riêng mình. Ngày
                nay, các doanh nghiệp thuộc mọi quy mô đều sử dụng Shopify,
          ...
          <div class="grid__item two-third-width push-left">
            <div class="section-heading no-margin-bottom">
              ...
              <p class="text-major no-gutter" style="color: #6b7177; font-weight: 400">
                Chúng tôi giúp mọi người có sự độc lập ngay từ lúc bắt đầu, điều hành và phát triển doanh nghiệp dễ dàng
                hơn. Chúng tôi tin rằng tương lai của thương mại có nhiều
                vai trò quan trọng hơn, chứ không phải ngày càng hạn chế hơn, vì vậy chúng tôi đang giảm bớt các rào cản
                đối với quyền sở hữu doanh nghiệp để làm cho thương mại tốt
                hơn cho mọi người.
              </p>
            </div>
          </div>
            ...
            <div class="section4-left">
              <div class="section-heading no-gutter">
                ...
                <p class="section-heading__subtitle text-major to-left to-center no-gutter">
                  Shopify đã phát triển từ 5 người trong một quán cà phê đến lên hơn 5.000 người trên toàn cầu. Với hơn
                  1.000.000 doanh nghiệp được cung cấp bởi Shopify, chúng
                  tôi quan tâm sâu sắc đến công việc chúng tôi làm. Chúng tôi là những người học hỏi liên tục, những
                  người phát triển theo sự thay đổi và tìm cách tạo ra sự thay
          ...
          <div class="grid__item grid__item--half">
            <div class="section5-content">
              <div class="section-heading no-gutter">
                ...
                <h2 class="heading-h2 to-left to-center little-gutter">Chúng tôi sẽ và đang xây dựng lại qui luât nền
                  kinh tế hiện đại</h2>
                <p class="section-heading__subtitle text-major to-left to-center">
                  Từ năm 2016 đến 2019 các doanh nghiệp Shopify đã đóng góp 319 tỷ đô la vào hoạc động kinh tế thế giới.
                  Hãy cùng tìm hiểu cách mà chúng tôi tạo nên động lực cho
          ...
          <div class="grid__item grid__item--half pull-half">
            <div class="section4-left">
              <div class="section-heading no-gutter">
                ...
                <p class="section-heading__subtitle text-major to-left to-center">
                  Shoptify xây dựng dựa trên sự bền vững đồng nghĩa với việc đóng góp vào cộng đồng. Quỹ Bền vững và các
                  sáng kiến ​​Tác động Xã hội của chúng tôi bao gồm lựa
                  chọn năng lượng tái tạo, giảm thiểu và bù đắp lượng khí thải carbon của chúng tôi, đồng thời tạo ra
                  một tương lai bình đẳng và bền vững bằng cách xây dựng các
          ...
          <div class="grid__item">
            <div class="card-group-sec7">
              <div class="block-sec7 card-sec7 resource-block">
                ...
                <p class="block-content resource-block-content">Giúp đỡ bạn 24/7 trước, trong và sau thời gian dùng thử
                  .</p>
              ...
              <div class="block-sec7 card-sec7 resource-block">
                ...
                <p class="block-content resource-block-content">Tìm hiểu cách bạn có thể có tác động bằng cách khám phá
                  các cơ hội tại Shopify.</p>
        ...
        <div class="grid">
          <div class="grid__item">
            <div class="section-heading section8-heading no-gutter">
              <h2 class="h-2 next-step">Trải nghiệm Shopify miễn phí, dịch vụ và khám phá công cụ bạn cần bắt đầu, điều
                hành và phát triển doanh nghiệp của mình.</h2>
